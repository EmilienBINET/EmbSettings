...
namespace emb {
    namespace settings {
        ...
        protected:
            ...
            template<typename Type>
            static std::map<std::string, Type> read_setting_map(std::string const& a_strFileClass, std::string const& a_strKey);
            template<typename Type>
            static void write_setting_map(std::string const& a_strFileClass, std::string const& a_strKey, std::map<std::string, Type> const& a_tmapNewValue);
            template<typename Type>
            static void set_setting_map(std::string const& a_strFileClass, std::string const& a_strKey, std::string const& a_strK, Type const& tVal);
        public:
        ...
        template<typename Class, char const* ClassName, typename Type, char const* TypeName,
            ...
            public:
                ...
                static void write(Type const& a_tVal) {
                    write_setting<Type>(File::Name, Key, a_tVal);
                }
                static void link(Type& a_rtVal) {
                    link_setting<Type, Class>(File::Name, Key, a_rtVal);
                }
        ...
        template<typename Class, char const* ClassName, typename Type, char const* TypeName,
            ...
            public:
                ...
                static void write(std::vector<Type> const& a_tvecVal) {
                    write_setting_vector<Type>(File::Name, Key, a_tvecVal);
                }
                static void add(Type const& a_tVal) {
                    add_setting_vector<Type>(File::Name, Key, a_tVal);
                }
                static void link(std::vector<Type>& a_rtvecVal) {
                    link_setting<std::vector<Type>, Class>(File::Name, Key, a_rtvecVal);
                }
                static std::unique_ptr<SettingsElement> CreateMethod() { return std::make_unique<Class>(); }
        };
        ...
        template<typename Class, char const* ClassName, typename Type, char const* TypeName,
            ...
            public:
                ...
                static void write(std::map<std::string, Type> const& a_tmapVal) {
                    write_setting_map<Type>(File::Name, Key, a_tmapVal);
                }
                static void set(std::string const& a_strKey, Type const& a_tVal) {
